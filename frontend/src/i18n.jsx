...
const T = {
  en: {
    ...
    'ai.chat_title':   'Battery AI',
    'ai.new_chat':     'New chat',
    'ai.placeholder':  'Ask about your design… (Enter to send)',
    'ai.empty_hint':   'Ask about your design or how to use the app.',
    'ai.conn_error':   'Connection error — is the backend running on port 8000?',
    'ai.chip.why_rejected': 'Why rejected?',
    'ai.chip.how_fix':      'How to fix it?',
    'ai.chip.explain':      'Explain result',
    'ai.chip.improve':      'Can I improve?',
    'ai.chip.how_use':      'How to use app?',
    'ai.chip.dod':          'What is DoD?',
  ...
  fr: {
    ...
    'ai.chat_title':   'Battery IA',
    'ai.new_chat':     'Nouveau chat',
    'ai.placeholder':  'Posez vos questions… (Entrée pour envoyer)',
    'ai.empty_hint':   'Posez vos questions sur votre conception ou l\'utilisation de l\'appli.',
    'ai.conn_error':   'Erreur de connexion — le backend tourne-t-il sur le port 8000 ?',
    'ai.chip.why_rejected': 'Pourquoi rejeté ?',
    'ai.chip.how_fix':      'Comment corriger ?',
    'ai.chip.explain':      'Expliquer le résultat',
    'ai.chip.improve':      'Peut-on améliorer ?',
    'ai.chip.how_use':      'Comment utiliser ?',
    'ai.chip.dod':          'Qu\'est-ce que la PdD ?',
