...
- Layer toggle UI (`LayerControlPanel.jsx`)
- Brackets, insulation cards, side/end plates, BMS, cables, heat shrink
- Export to GLTF/STL (client-side Three.js) and STEP (backend via CadQuery)
